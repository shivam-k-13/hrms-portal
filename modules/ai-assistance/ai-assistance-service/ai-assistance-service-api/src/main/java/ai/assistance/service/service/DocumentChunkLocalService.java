...
/**
 * Provides the local service interface for DocumentChunk. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentChunkLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocumentChunkLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ai.assistance.service.service.impl.DocumentChunkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the document chunk local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentChunkLocalServiceUtil} if injection and service tracking are not available.
	 */
...
// LIFERAY-SERVICE-BUILDER-HASH:895550827