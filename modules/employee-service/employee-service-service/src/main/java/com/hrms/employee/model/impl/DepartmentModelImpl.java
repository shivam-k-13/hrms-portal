...
import com.hrms.employee.model.DepartmentModel;
...
/**
 * The base model implementation for the Department service. Represents a row in the &quot;HRMS_Department&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DepartmentModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "HRMS_Department";

	public static final Object[][] TABLE_COLUMNS = {
		{"departmentId", Types.BIGINT}, {"departmentCode", Types.VARCHAR},
		{"departmentName", Types.VARCHAR}, {"description", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table HRMS_Department (departmentId LONG not null primary key,departmentCode VARCHAR(75) null,departmentName VARCHAR(75) null,description VARCHAR(75) null,status VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table HRMS_Department";

	public static final String ORDER_BY_JPQL =
		" ORDER BY department.departmentId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY HRMS_Department.departmentId ASC";
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("status", Department::getStatus);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"departmentCode",
				(BiConsumer<Department, String>)Department::setDepartmentCode);
			attributeSetterBiConsumers.put(
				"departmentName",
			...
			attributeSetterBiConsumers.put(
				"status",
				(BiConsumer<Department, String>)Department::setStatus);
			attributeSetterBiConsumers.put(
				"groupId",
	...
	public Object clone() {
		...
		departmentImpl.setStatus(getStatus());
	...
	public CacheModel<Department> toCacheModel() {
		...
		departmentCacheModel.status = getStatus();

		String status = departmentCacheModel.status;

		if ((status != null) && (status.length() == 0)) {
			departmentCacheModel.status = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("departmentCode", _departmentCode);
	...
	static {
		...
		columnBitmasks.put("departmentCode", 2L);
...
// LIFERAY-SERVICE-BUILDER-HASH:465466271