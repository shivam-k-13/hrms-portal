 ...
 * <code>com.hrms.leave.service.impl.LeaveRequestLocalServiceImpl</code> and
...
public class LeaveRequestLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.hrms.leave.service.impl.LeaveRequestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static LeaveRequest rejectLeave(
			long leaveRequestId, long approverUserId, String approverComments)
		throws PortalException {

		return getService().rejectLeave(
			leaveRequestId, approverUserId, approverComments);
	}
